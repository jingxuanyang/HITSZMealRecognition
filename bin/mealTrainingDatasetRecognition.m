...
% Purpose: verify training dataset
% Note   :

%% verify training dataset
% print hints
fprintf('Verifying training dataset\n');

% draw result figure
figure;

% loop all training figures
for i = 1:size(trainingDataTbl, 1)

    % read and detect training figure i
    I = imread(trainingDataTbl.imageFilename{i});
